...
const BangunRuang = () => {
  const items = [
    ...
    },
    {
      content: (
        <Link
          href="/bangun-ruang/limas-segitiga"
          className="w-full py-2 text-white hover:opacity-75 transition-all duration-300 font-poppins text-[20px] block text-center"
        >
          Limas Segitiga
        </Link>
    ...
    },
    {
      content: (
        <Link
          href="/bangun-ruang/limas-segiempat"
          className="w-full py-2 text-white hover:opacity-75 transition-all duration-300 font-poppins text-[20px] block text-center"
        >
          Limas Segiempat
        </Link>
    ...
    },
    {
      content: (
        <Link
          href="/bangun-ruang/prisma-segitiga"
          className="w-full py-2 text-white hover:opacity-75 transition-all duration-300 font-poppins text-[20px] block text-center"
        >
          Prisma Segitiga
        </Link>
