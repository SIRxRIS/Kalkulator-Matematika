            ...
            style={
              {
                ...
                filter: manualMode
                  ...
                  ? `blur(0px)`
                  : `blur(${blurAmount}px)`,
                transition: `filter ${animationDuration}s ease, opacity ${animationDuration}s ease`, // Modified
                opacity: isActive ? 1 : 0.7, // Add this line
                "--border-color": borderColor,
                "--glow-color": glowColor,
                marginRight: "8px", // Add this line
                fontSize: "32px", // Add this line
